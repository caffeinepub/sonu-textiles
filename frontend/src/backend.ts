...
export class Backend implements backendInterface {
    ...
    async getClothingItemsByPrice(): Promise<Array<ClothingItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getClothingItemsByPrice();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMehndiDesignsByPrice(): Promise<Array<MehndiDesign>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMehndiDesignsByPrice();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
